...
@section('title', 'Prediction Checkout')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="border-b pb-4 mb-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="font-bold">{{ $predictionData['type'] }} Prediction</h3>
                        <p class="text-gray-600">For: {{ $predictionData['name'] }}</p>
                        <p class="text-indigo-600 font-bold">₹{{ number_format($predictionData['amount'], 2) }}</p>
                    </div>
                </div>
            </div>
            <div class="text-right">
                <p class="text-2xl font-bold">Total: ₹{{ number_format($predictionData['amount'], 2) }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form action="{{ route('predictions.order.place') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    <p class="text-sm text-blue-700">
                        ...
                        You will receive your {{ strtolower($predictionData['type']) }} prediction report within 24-48 hours after payment confirmation.
                    </p>
                </div>
