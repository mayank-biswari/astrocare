...
@section('title', 'Forgot Password - ' . \App\Models\SiteSetting::get('site_name', 'AstroServices'))
    ...
    <div class="max-w-md w-full space-y-6 sm:space-y-8">
        <div class="bg-white rounded-lg shadow-xl p-4 sm:p-8">
            <div class="text-center">
                <h2 class="text-xl sm:text-3xl font-bold text-gray-900 mb-2">Forgot Password?</h2>
                <p class="text-sm sm:text-base text-gray-600">No problem. Just let us know your email address and we will email you a password reset link.</p>
            </div>
