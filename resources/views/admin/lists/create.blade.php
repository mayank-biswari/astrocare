...
@section('title', 'Create ' . ucfirst($type) . ' List')
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create {{ ucfirst($type) }} List</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{ route('admin.lists.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="method_query_builder" name="method" value="query_builder" checked>
                                        <label for="method_query_builder" class="custom-control-label">Query Builder</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="method_manual" name="method" value="manual">
                                        <label for="method_manual" class="custom-control-label">Manual Selection</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="method_sql" name="method" value="sql">
                ...
                <!-- Query Builder -->
                <div class="card method-config" id="query_builder_config">
                    <div class="card-header">
                        ...
                        <div id="filters-container">
                            <div class="filter-row mb-3">
                                <div class="row">
                                    <div class="col-md-3">
                                        <select name="filters[0][field]" class="form-control">
                                            ...
                                            @else
                                                ...
                                                <option value="cms_category_id">Category</option>
                                                <option value="page_type_id">Page Type</option>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="filters[0][value]" class="form-control filter-value" placeholder="Value">
                                        <select name="filters[0][value]" class="form-control filter-select" style="display: none;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ $type === 'products' ? 'Name' : 'Title' }}</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
                ...
                <!-- Manual Selection -->
                <div class="card method-config" id="manual_config" style="display: none;">
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="item_{{ $item->id }}" name="selected_ids[]" value="{{ $item->id }}">
                                    <label for="item_{{ $item->id }}" class="custom-control-label">
                                        {{ $type === 'products' ? $item->name : $item->title }}
                                    </label>
                                </div>
                            </div>
                            @endforeach
                ...
                <!-- SQL Query -->
                <div class="card method-config" id="sql_config" style="display: none;">
                    <div class="card-header">
                        <h3 class="card-title">SQL Query</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <textarea name="sql_query" class="form-control" rows="10" placeholder="SELECT * FROM {{ $type === 'products' ? 'products' : 'cms_pages' }} WHERE..."></textarea>
                        </div>
                        <button type="button" class="btn btn-info" id="test-sql">Test Query</button>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="is_template" name="is_template">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="create_page" name="create_page">
                        ...
                        <div id="page-creation-fields" class="row mt-3" style="display: none;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_title" class="form-control" placeholder="e.g., Our Services">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Page URL Slug</label>
                                    <input type="text" name="page_slug" class="form-control" placeholder="e.g., our-services">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Page Description</label>
                                    <textarea name="page_description" class="form-control" rows="3" placeholder="Brief description of the page content"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div id="template-fields" class="row" style="display: none;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="template_name" class="form-control" placeholder="e.g., Active Hero Pages">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="template_category" class="form-control">
                                        ...
                                        <option value="status">Status Filters</option>
                                        <option value="type">Type Filters</option>
    ...
    function handleFieldChange(fieldSelect) {
        ...
        if ((type === 'products' && field === 'category') || (type === 'pages' && field === 'cms_category_id')) {
            ...
            categories.forEach(cat => {
                valueSelect.innerHTML += `<option value="${cat.id}">${cat.name}</option>`;
            });
            ...
            statusOptions.forEach(option => {
                valueSelect.innerHTML += `<option value="${option.value}">${option.label}</option>`;
            });
            ...
            pageTypes.forEach(pt => {
                valueSelect.innerHTML += `<option value="${pt.id}">${pt.name}</option>`;
            });
        } else {
                    ...
                    filterRow.innerHTML = `
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="filters[${index}][value]" class="form-control filter-select" style="display: none;"></select>
                            </div>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-danger remove-filter">Remove</button>
                            </div>
