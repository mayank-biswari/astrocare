...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Dynamic Page</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="system_name" class="form-control" value="{{ $page->system_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" id="is_published" name="is_published" {{ $page->is_published ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div id="sections-container">
                            ...
                            <div class="section-item border mb-3" data-index="{{ $index }}">
                                <div class="card-header bg-light" style="cursor: move;" data-toggle="collapse" data-target="#section-{{ $index }}">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <span class="section-title">{{ $section['name'] ?? 'Section ' . ($index + 1) }}</span>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sections[{{ $index }}][name]" class="form-control section-name" value="{{ $section['name'] ?? '' }}" placeholder="Enter section name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="sections[{{ $index }}][custom_template]" class="form-control" rows="5" placeholder="Enter HTML with @{{title@}}, @{{body@}}, @{{image@}}, @{{slug@}}, @{{url@}} OR enter view:filename to use a blade template">{{ $section['custom_template'] ?? '' }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sections[{{ $index }}][section_classes]" class="form-control" value="{{ $section['section_classes'] ?? '' }}" placeholder="e.g., container mx-auto px-4 py-8">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="sections[{{ $index }}][type]" class="form-control section-type">
                                                ...
                                                <option value="html" {{ ($section['type'] ?? '') === 'html' ? 'selected' : '' }}>Custom HTML</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group list-field" style="{{ ($section['type'] ?? '') === 'html' ? 'display: none;' : '' }}">
                                            ...
                                            <select name="sections[{{ $index }}][list_id]" class="form-control">
                                                ...
                                                @foreach($lists as $list)
                                                    <option value="{{ $list->id }}" {{ ($section['list_id'] ?? '') == $list->id ? 'selected' : '' }}>{{ $list->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group list-field" style="{{ ($section['type'] ?? '') === 'html' ? 'display: none;' : '' }}">
                                            ...
                                            <select name="sections[{{ $index }}][layout]" class="form-control layout-select">
                                                ...
                                                <option value="slider" {{ ($section['layout'] ?? '') === 'slider' ? 'selected' : '' }}>Slider</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3 list-field" style="{{ ($section['type'] ?? '') === 'html' ? 'display: none;' : '' }}">
                                        <div class="form-group">
                                            <label>Grid Classes</label>
                                            <input type="text" name="sections[{{ $index }}][grid_classes]" class="form-control" value="{{ $section['grid_classes'] ?? 'grid md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8' }}" placeholder="grid md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                                ...
                                <div class="slider-options" style="{{ ($section['layout'] ?? '') === 'slider' && ($section['type'] ?? '') === 'list' ? '' : 'display: none;' }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="show_dots_{{ $index }}" name="sections[{{ $index }}][show_dots]" {{ ($section['show_dots'] ?? true) ? 'checked' : '' }}>
                                                <label for="show_dots_{{ $index }}" class="custom-control-label">Show Dots</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="show_arrows_{{ $index }}" name="sections[{{ $index }}][show_arrows]" {{ ($section['show_arrows'] ?? true) ? 'checked' : '' }}>
                                                <label for="show_arrows_{{ $index }}" class="custom-control-label">Show Arrows</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="auto_rotate_{{ $index }}" name="sections[{{ $index }}][auto_rotate]" {{ ($section['auto_rotate'] ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="sections[{{ $index }}][duration]" class="form-control" value="{{ $section['duration'] ?? 3000 }}" min="1000">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="sections[{{ $index }}][slides_to_show]" class="form-control" value="{{ $section['slides_to_show'] ?? 3 }}" min="1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Slides to Scroll</label>
                                                <input type="number" name="sections[{{ $index }}][slides_to_scroll]" class="form-control" value="{{ $section['slides_to_scroll'] ?? 1 }}" min="1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="html-field" style="{{ ($section['type'] ?? '') === 'list' ? 'display: none;' : '' }}">
                                    <div class="form-group">
                                        <label>Custom HTML</label>
                                        <textarea name="sections[{{ $index }}][html]" class="form-control" rows="5">{{ $section['html'] ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="list-options list-field" style="{{ ($section['type'] ?? '') === 'html' ? 'display: none;' : '' }}">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="make_clickable_list_{{ $index }}" name="sections[{{ $index }}][make_clickable]" {{ ($section['make_clickable'] ?? true) ? 'checked' : '' }}>
                                                <label for="make_clickable_list_{{ $index }}" class="custom-control-label">Make Items Clickable</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="show_read_more_list_{{ $index }}" name="sections[{{ $index }}][show_read_more]" {{ ($section['show_read_more'] ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sections[{{ $index }}][read_more_text]" class="form-control" value="{{ $section['read_more_text'] ?? 'Read More' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meta_title" class="form-control" value="{{ $page->meta_title }}" placeholder="Page meta title">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" class="form-control" rows="3" placeholder="Page meta description">{{ $page->meta_description }}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="css-files-container">
                                        @forelse($page->external_css ?? [] as $css)
                                        <div class="input-group mb-2">
                                            <input type="url" name="external_css[]" class="form-control" value="{{ $css }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="js-files-container">
                                        @forelse($page->external_js ?? [] as $js)
                                        <div class="input-group mb-2">
                                            <input type="url" name="external_js[]" class="form-control" value="{{ $js }}">
                                            <div class="input-group-append">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="custom_css" class="form-control" rows="10" placeholder="/* Custom CSS */">{{ $page->custom_css }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Custom JavaScript</label>
                                    <textarea name="custom_js" class="form-control" rows="10" placeholder="// Custom JavaScript">{{ $page->custom_js }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section-item border p-3 mb-3" data-index="${sectionIndex}">
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Section Type</label>
                        <select name="sections[${sectionIndex}][type]" class="form-control section-type">
                ...
                <div class="col-md-3">
                    <div class="form-group list-field">
                        <label>Select List</label>
                        <select name="sections[${sectionIndex}][list_id]" class="form-control">
                            <option value="">Select List</option>
                            @foreach($lists as $list)
                ...
                <div class="col-md-3">
                    <div class="form-group list-field">
                        <label>Layout</label>
                        <select name="sections[${sectionIndex}][layout]" class="form-control">
                ...
                <div class="col-md-2">
                    <div class="form-group list-field">
                        <label>Columns/Limit</label>
                        <input type="number" name="sections[${sectionIndex}][limit]" class="form-control" value="12" min="1">
                    </div>
                </div>
                <div class="col-md-1">
                    <button type="button" class="btn btn-danger btn-sm mt-4 remove-section">
            ...
            <div class="html-field" style="display: none;">
                <div class="form-group">
                    <label>Custom HTML</label>
                    <textarea name="sections[${sectionIndex}][html]" class="form-control" rows="5"></textarea>
                </div>
            </div>
        </div>
    `;
        ...
        <div class="section-item border mb-3" data-index="${index}">
            ...
            <div id="section-${index}" class="collapse">
                ...
                <div class="col-md-3">
                    <div class="form-group list-field">
                        <label>Layout</label>
                        <select name="sections[${index}][layout]" class="form-control">
                            <option value="grid">Grid</option>
                            <option value="list">List</option>
                            <option value="slider">Slider</option>
                        </select>
