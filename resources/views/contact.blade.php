...
<div class="container mx-auto px-4 py-4 sm:py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-xl sm:text-4xl font-bold text-center mb-4 sm:mb-8">Contact Us</h1>
        ...
        <div class="flex justify-center">
            <div class="w-full {{ $contactInfo['show_contact_info'] ? 'grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8' : 'max-w-2xl' }}">
                <!-- Contact Form -->
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-lg">
                    <h2 class="text-lg sm:text-2xl font-bold mb-4 sm:mb-6">Send us a Message</h2>
                ...
                <form action="{{ route('contact.store') }}" method="POST">
                    ...
                    <button type="submit" class="w-full bg-indigo-600 text-white text-sm sm:text-base py-2 sm:py-3 px-4 rounded-lg hover:bg-indigo-700 transition duration-200">
                        Send Message
                    </button>
                </form>
                </div>
                ...
                <!-- Contact Information -->
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-lg">
                    <h2 class="text-lg sm:text-2xl font-bold mb-4 sm:mb-6">Get in Touch</h2>

                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        <i class="fas fa-map-marker-alt text-indigo-600 mt-1"></i>
                        <div>
                            <h4 class="font-bold text-sm sm:text-base">Address</h4>
                            <p class="text-sm sm:text-base text-gray-600">{!! nl2br(e($contactInfo['address'])) !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-bold text-sm sm:text-base">Phone</h4>
                            <p class="text-sm sm:text-base text-gray-600">{{ $contactInfo['phone'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-bold text-sm sm:text-base">Email</h4>
                            <p class="text-sm sm:text-base text-gray-600">{{ $contactInfo['email'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-bold text-sm sm:text-base">Business Hours</h4>
                            <p class="text-sm sm:text-base text-gray-600">{!! nl2br(e($contactInfo['business_hours'])) !!}</p>
                        </div>
                    </div>
                </div>

                <div class="mt-6 sm:mt-8">
                    <h3 class="text-base sm:text-xl font-bold mb-4">Follow Us</h3>
