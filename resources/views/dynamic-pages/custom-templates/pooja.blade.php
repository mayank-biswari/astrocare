...
@section('content')
<div class="bg-gradient-to-b from-orange-50 to-white min-h-screen py-4 sm:py-8">
    <div class="container mx-auto px-4 max-w-6xl">
        <nav class="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-6 flex items-center gap-2">
        ...
        <div class="grid lg:grid-cols-5 gap-4 sm:gap-8">
            <!-- Left: Pooja Details -->
            <div class="lg:col-span-3 space-y-3 sm:space-y-6">
                <!-- Image Card -->
                @if($page->image)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <img src="{{ asset('storage/' . $page->image) }}" alt="{{ $page->title }}" class="w-full h-48 sm:h-80 object-cover">
                </div>
                @endif

                <!-- Title & Price Card -->
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl shadow-lg p-4 sm:p-8 text-white">
                    <h1 class="text-xl sm:text-4xl font-bold mb-3 sm:mb-4">{{ $page->title }}</h1>
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                        <div class="bg-white/20 backdrop-blur-sm rounded-xl px-4 sm:px-6 py-2 sm:py-3">
                            <div class="text-xs sm:text-sm opacity-90">Starting from</div>
                            <div class="text-xl sm:text-3xl font-bold">{{ formatPrice($page->custom_fields['price'] ?? 0) }}</div>
                        </div>
                        @if($page->custom_fields['duration'] ?? null)
                        <div class="bg-white/20 backdrop-blur-sm rounded-xl px-4 sm:px-6 py-2 sm:py-3">
                            <div class="text-xs sm:text-sm opacity-90">Duration</div>
                            <div class="text-lg sm:text-2xl font-bold">{{ $page->custom_fields['duration'] }} min</div>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-4 sm:p-8">
                    <div class="flex items-center gap-3 mb-3 sm:mb-4">
                        ...
                        <h3 class="text-lg sm:text-2xl font-bold text-gray-800">About This Pooja</h3>
                    </div>
                    <div class="text-sm sm:text-lg text-gray-700 leading-relaxed">{!! $page->body !!}</div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-4 sm:p-8">
                    <div class="flex items-center gap-3 mb-3 sm:mb-4">
                        ...
                        <h3 class="text-lg sm:text-2xl font-bold text-gray-800">What's Included</h3>
                    </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg p-4 sm:p-8">
                    <div class="flex items-center gap-3 mb-3 sm:mb-4">
                        <div class="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-star text-purple-600"></i>
                        </div>
                        <h3 class="text-lg sm:text-2xl font-bold text-gray-800">Benefits</h3>
                    </div>
                    <div class="grid sm:grid-cols-2 gap-3">
                ...
                <!-- Ritual Info -->
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-4 sm:p-8">
                    <div class="flex items-center gap-3 mb-3 sm:mb-4">
                        <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-info-circle text-blue-600"></i>
                        </div>
                        <h3 class="text-lg sm:text-2xl font-bold text-gray-800">Ritual Information</h3>
                    </div>
            ...
            <div class="lg:col-span-2">
                <div class="sticky top-8">
                    <div class="bg-white rounded-2xl shadow-2xl p-4 sm:p-8 border-2 border-orange-100">
                        <div class="text-center mb-4 sm:mb-6">
                            <div class="inline-block bg-orange-100 rounded-full p-3 sm:p-4 mb-3 sm:mb-4">
                                <i class="fas fa-calendar-alt text-orange-600 text-xl sm:text-3xl"></i>
                            </div>
                            <h2 class="text-xl sm:text-3xl font-bold text-gray-800 mb-2">Book This Pooja</h2>
                            <p class="text-sm sm:text-base text-gray-600">Fill the form to proceed with booking</p>
                        </div>
                        ...
                        <form action="{{ route('pooja.book') }}" method="POST" class="space-y-5">
                            ...
                            <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-3 sm:p-5 border-2 border-orange-200">
                                <div class="flex justify-between items-center mb-3 sm:mb-4">
                                    <span class="text-sm sm:text-base text-gray-700 font-semibold">Total Amount:</span>
                                    <span class="text-xl sm:text-3xl font-bold text-orange-600">{{ formatPrice($page->custom_fields['price'] ?? 0) }}</span>
                                </div>
                                <button type="submit" class="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-bold text-sm sm:text-lg shadow-lg hover:shadow-xl transition transform hover:scale-105">
