<div class="slider-container mb-4 sm:mb-8">
    <div class="dynamic-slider slider-{{ $loopIndex }}">
        @foreach($items as $item)
            ...
            <div class="slide px-2">
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-lg {{ $isClickable ? 'cursor-pointer hover:shadow-lg' : '' }}" @if($isClickable) onclick="location.href='{{ $itemUrl }}'" @endif>
