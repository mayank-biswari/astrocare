@php
    $gridClasses = $section['grid_classes'] ?? 'grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6 mb-4 sm:mb-8';
@endphp
...
<div class="{{ $gridClasses }}">
    @foreach($items as $item)
        ...
        @endphp
        <a href="{{ $itemUrl }}" class="bg-white p-3 sm:p-6 rounded-lg shadow text-center hover:shadow-lg transition">
            <div class="text-xl sm:text-3xl mb-3 flex justify-center">
