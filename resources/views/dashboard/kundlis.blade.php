...
<div class="bg-white rounded-lg shadow-md p-6 mb-8">
    <h1 class="text-3xl font-bold text-gray-900">My Kundlis</h1>
</div>

<div class="flex justify-end mb-6">
    <a href="{{ route('kundli.create') }}" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 shadow-md hover:shadow-lg transition-all">
        <i class="fas fa-plus-circle mr-2"></i>Generate New Kundli
    </a>
</div>
        ...
        @foreach($kundlis as $kundli)
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('kundli.download', $kundli->id) }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Download PDF</a>
                    <a href="{{ route('consultations.index') }}" class="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600">Get Consultation</a>
                </div>
            </div>
        @endforeach
    </div>
