...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">New Lead</h2>
            <p class="text-sm text-gray-500 mt-1">Fill in the details below to create a new lead.</p>
        </div>

        <form action="{{ route('lms.leads.store') }}" method="POST" class="px-6 py-6 space-y-6">
            @csrf
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="message" id="message" rows="4"
                              ...
                              placeholder="Any additional notes or message from the lead...">{{ old('message') }}</textarea>
                    @error('message')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
